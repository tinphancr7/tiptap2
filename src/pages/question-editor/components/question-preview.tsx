				...
				<div>
					...
					{baseData.questionTitle ? (
						<div className="tiptap">
							<div dangerouslySetInnerHTML={{__html: baseData.questionTitle}} />
						</div>
					) : (
						<div className="w-full h-11 border border-gray-300 rounded-lg p-3 flex items-center text-gray-400">
					...
					{baseData.showQuestionDescription && (
						<div className="mt-3">
							...
							{baseData.questionDescription ? (
								...
								<div className="w-full h-11 border border-gray-300 rounded-lg p-3  flex items-center text-gray-400 text-sm">
									Enter description for question
								</div>
							)}
						</div>
					)}
					...
					{baseData.showCorrectAnswerDescription && (
						<div className="mt-3">
							...
							{baseData.correctAnswerDescription ? (
								...
								<div className="w-full h-16 border border-gray-300 rounded-lg p-3 bg-gray-50 flex items-center text-gray-400 text-sm">
									Enter description for correct answer
								</div>
							)}
						</div>
					)}
	...
	return (
		<div className="sticky top-8 border border-gray-200 rounded-lg p-6 bg-white">
			...
			{questionType === "fill-in-blank"
				...
				? questionGroupData && <QuestionGroupPreview data={questionGroupData} />
